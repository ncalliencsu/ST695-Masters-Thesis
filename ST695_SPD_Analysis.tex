...
\NormalTok{formula\_6W }\OtherTok{\textless{}{-}} \FunctionTok{as.formula}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Y\_W \textasciitilde{} ("}\NormalTok{,}
    \FunctionTok{paste}\NormalTok{(WP\_factors, }\AttributeTok{collapse =} \StringTok{" + "}\NormalTok{),}\StringTok{")\^{}3"}\NormalTok{))}
\NormalTok{model\_6W }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(formula\_6W, }\AttributeTok{data =}\NormalTok{ Yw\_data)}
\NormalTok{effects\_6W }\OtherTok{\textless{}{-}} \FunctionTok{coef}\NormalTok{(model\_6W)[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]}
\NormalTok{effect\_names\_6W }\OtherTok{\textless{}{-}} \FunctionTok{names}\NormalTok{(}\FunctionTok{coef}\NormalTok{(model\_6W))[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]}
\FunctionTok{halfnormal}\NormalTok{(}
\NormalTok{  effects\_6W,}
  \AttributeTok{main =} \StringTok{"Half{-}Normal Plot for W Model"}\NormalTok{,}
  \AttributeTok{labs =}\NormalTok{ effect\_names\_6W,}
  \AttributeTok{alpha =} \DecValTok{1}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\# Model for WP factors (main effects, 2{-} and 3{-}way interactions)}
\NormalTok{formula\_7W }\OtherTok{\textless{}{-}} \FunctionTok{as.formula}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Y\_W \textasciitilde{} ("}\NormalTok{,}
    \FunctionTok{paste}\NormalTok{(WP\_factors, }\AttributeTok{collapse =} \StringTok{" + "}\NormalTok{),}\StringTok{")\^{}3"}\NormalTok{))}
\NormalTok{model\_7W }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(formula\_7W, }\AttributeTok{data =}\NormalTok{ Yw\_data)}
\NormalTok{effects\_7W }\OtherTok{\textless{}{-}} \FunctionTok{coef}\NormalTok{(model\_7W)[}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]  }\CommentTok{\# Remove intercept}
\FunctionTok{LenthPlot}\NormalTok{(effects\_7W, }\AttributeTok{main =} \StringTok{"Lenth Plot for W Model"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#S Model {-} SP Factors (main SP effects, 2{-}way interactions}
\CommentTok{\# and 2{-}way interactions with WP Factors)}
\NormalTok{formula\_S }\OtherTok{\textless{}{-}} \FunctionTok{as.formula}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Y\_S \textasciitilde{} ("}\NormalTok{, }\FunctionTok{paste}\NormalTok{(linear\_terms, }
                                  \AttributeTok{collapse =} \StringTok{" + "}\NormalTok{),}\StringTok{")\^{}2"}\NormalTok{))}
\CommentTok{\#Create model matrix for S Model}
\NormalTok{Y\_S }\OtherTok{\textless{}{-}}\NormalTok{ Ys\_data}\SpecialCharTok{$}\NormalTok{Y\_S}
\NormalTok{X\_S }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(formula\_S, }\AttributeTok{data =}\NormalTok{ Ys\_data)}

\CommentTok{\#W Model {-} WP factors (main WP effects, 2{-}way interactions)}
\NormalTok{formula\_W }\OtherTok{\textless{}{-}} \FunctionTok{as.formula}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Y\_W \textasciitilde{} ("}\NormalTok{, }
              \FunctionTok{paste}\NormalTok{(WP\_factors, }\AttributeTok{collapse =} \StringTok{" + "}\NormalTok{),}\StringTok{")\^{}2"}\NormalTok{))}

\NormalTok{X\_W }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(formula\_W, }\AttributeTok{data =}\NormalTok{ Yw\_data)}
\CommentTok{\# Replicate each row 4 times and drop row 20.}
\NormalTok{X\_W }\OtherTok{\textless{}{-}}\NormalTok{ X\_W[}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(X\_W), }\AttributeTok{each =} \DecValTok{4}\NormalTok{), ][}\SpecialCharTok{{-}}\DecValTok{20}\NormalTok{, ]}

\NormalTok{Y\_W }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(Yw\_data}\SpecialCharTok{$}\NormalTok{Y\_W, }\AttributeTok{each =} \DecValTok{4}\NormalTok{)[}\SpecialCharTok{{-}}\DecValTok{20}\NormalTok{]}
\NormalTok{df\_W }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(Y\_W, X\_W)}

\CommentTok{\#S{-}W Model}
\CommentTok{\#Create model matrix for S{-}W Model}
\NormalTok{X\_SW }\OtherTok{\textless{}{-}}\NormalTok{ X\_S[, SP\_effects\_names]}
\NormalTok{Y\_SW }\OtherTok{\textless{}{-}}\NormalTok{ Y\_S }\SpecialCharTok{{-}}\NormalTok{ Y\_W}
\NormalTok{df\_SW }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(Y\_SW, X\_SW, }\AttributeTok{check.names =} \ConstantTok{FALSE}\NormalTok{)}
\NormalTok{  formula\_SW }\OtherTok{\textless{}{-}} \FunctionTok{as.formula}\NormalTok{(}
  \StringTok{"Y\_SW \textasciitilde{} D + R + \textasciigrave{}D:R\textasciigrave{} + \textasciigrave{}T:D\textasciigrave{} + \textasciigrave{}T:R\textasciigrave{} + \textasciigrave{}P:D\textasciigrave{} + \textasciigrave{}P:R\textasciigrave{} + \textasciigrave{}S:D\textasciigrave{} + \textasciigrave{}S:R\textasciigrave{}"}\NormalTok{)}
