...
halfnormal(effects_wp, main = "Half-Normal Plot: WP Factors + 2-way Interactions", 
...
halfnormal(effects_sp, main = "Half-Normal Plot: SP Factors + 2-way Interaction", 
           labs = effect_names_sp, alpha = 1)
...
model <- lm(Denier ~ (T + P + S)^2 + D + R + D:R, data = Ys_data)
effects <- coef(model)[-1]  # Remove intercept
